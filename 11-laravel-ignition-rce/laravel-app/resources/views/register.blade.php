                    ...
                    <form method="post">
                        ...
                        <div class="form-outline mb-4">
                            <input type="name" id="name" name="name" class="form-control form-control-lg"
                                   placeholder="Enter a valid username" required maxlength="32"/>
                            @if($errors->has('name'))
                        ...
                        <div class="form-outline mb-3">
                            <input type="password" id="confirmation" name="confirmpassword" class="form-control form-control-lg"
                                   placeholder="Confirm password" required maxlength="32"/>
